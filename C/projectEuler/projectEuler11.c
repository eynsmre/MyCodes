...
int main()
{
    ...
    for(i=0;i<size1;i++){
    	...
    	for(j=0;j<4;j++){
    		...
    		product1 *= arr1[j];
    		product2 *= arr1[i + j*20];
			
			if(i%20 >= 3)
				product3 *= arr1[i + j*19];
				
			product4 *= arr1[i + j*21];
        }
